                ...
                return (
                  <tr key={c.id} className="border-b border-gray-50 last:border-0 hover:bg-gray-50">
                    <td className="p-2 md:p-3 text-gray-800 font-medium text-[10px] md:text-sm">
                      {c.term.endDate} <span className="text-[8px] md:text-xs text-red-500 font-bold ml-1">({daysLeft}일)</span>
                    </td>
                    <td className="p-2 md:p-3 text-gray-600 text-[10px] md:text-sm truncate max-w-[60px] md:max-w-none">{tenant}</td>
                    <td className="p-2 md:p-3 text-right text-gray-600 text-[10px] md:text-sm tracking-tight">{term ? formatMoney(term.deposit) : '-'}</td>
